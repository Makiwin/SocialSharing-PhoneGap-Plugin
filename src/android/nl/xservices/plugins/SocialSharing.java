  ...
  private boolean doSendIntent(
    ...
    cordova.getThreadPool().execute(new SocialSharingRunnable(callbackContext) {
      public void run() {
        ...
        final PendingIntent pendingIntent = PendingIntent.getBroadcast(cordova.getActivity().getApplicationContext(), 0, receiverIntent, PendingIntent.PendingIntent.FLAG_IMMUTABLE || PendingIntent.FLAG_IMMUTABLE);
